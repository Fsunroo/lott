...
contract Lottery {
    ...
    constructor() {
        owner = msg.sender;
        degenToken = IERC20(0x4ed4E862860beD51a9570b96d89aF5E1B0Efefed);
    }
    ...
    function buyTickets(uint256 numTickets) external payable {
        ...
        uint256 totalCost = numTickets * rounds[currentRoundId].ticketPrice;
        require(degenToken.transferFrom(msg.sender, address(this), totalCost), "Token transfer failed");
